...
describe('SalesManagerTest', () => {
  ...
  test('addTest', () => {
    ...
    expect(manager.salesArr[0].isSelected).toBe(false);
    expect(manager.salesArr[0].id).toBe(1);

    // 2つ目追加した際の確認
    sale = new Sale(new Product('お茶', '2022-07-20', 60, 150, 600), '2022-07-28', 200, true, 2);
    ...
    expect(manager.salesArr[1].isSelected).toBe(true);
  ...
  test('getTotalSalesTest', () => {
    ...
    // 3つ目の追加
    sale = new Sale(new Product('アイス', '2022-07-20', 60, 200, 600), '2022-07-28', 600, true, 3);
    manager.add(sale);
